object fCadMunicipios: TfCadMunicipios
  Left = 0
  Top = 0
  Width = 991
  Height = 1001
  ...
  object Municipios: TFDQuery
    BeforePost = MunicipiosBeforePost
    BeforeDelete = MunicipiosBeforeDelete
    Filtered = True
    Connection = UniMainModule.Conecta
    ...
    SQL.Strings = (
      ...
      '      ,UF'
        ...
        '      ,Estado = (select Nome from Estados est where est.uf = mun' +
        '.uf)'
      'FROM Municipios mun')
    Left = 36
    Top = 144
    ...
    object MunicipiosNumero: TSmallintField
      FieldName = 'Numero'
      Origin = 'Numero'
    end
    ...
    object MunicipiosEstado: TStringField
      FieldKind = fkLookup
      FieldName = 'Estado'
