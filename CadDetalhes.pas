...
uses
  ...
  FireDAC.Stan.Async, FireDAC.DApt, FireDAC.Comp.DataSet, uniRadioGroup, uniDBRadioGroup, uniSweetAlert;
...
procedure TfCadDetalhes.DetalhesBeforeDelete(DataSet: TDataSet);
begin
