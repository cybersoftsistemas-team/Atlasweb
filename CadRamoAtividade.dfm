object fCadRamoAtividade: TfCadRamoAtividade
  Left = 0
  Top = 0
  Width = 991
  Height = 1001
  ...
  object dsRamo: TDataSource
    DataSet = RamoAtividade
    Left = 34
    Top = 181
  end
  object RamoAtividade: TFDQuery
    BeforePost = RamoAtividadeBeforePost
    BeforeDelete = RamoAtividadeBeforeDelete
