object dmFiscal: TdmFiscal
  ...
  object Notas: TMSQuery
    SQLInsert.Strings = (
      'INSERT INTO NotasFiscais'
        ...
        'centivo_Codigo, Aliquota_ICMSPresumido)'
      'VALUES'
        ...
        ':Incentivo_Codigo, :Aliquota_ICMSPresumido)')
    SQLDelete.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        ', Incentivo_Codigo, Aliquota_ICMSPresumido FROM NotasFiscais'
      'WHERE'
  ...
  object NotasItens: TMSQuery
    SQLInsert.Strings = (
      'INSERT INTO NotasItens'
        ...
        'or_BCICMSPresumido, Valor_ICMSPresumido, Aliquota_ICMSPresumido)'
      'VALUES'
        ...
        ':Valor_COFINSST, :Valor_BCICMSPresumido, :Valor_ICMSPresumido, :' +
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'CMSPresumido, Valor_ICMSPresumido = :Valor_ICMSPresumido, Aliquo' +
        'ta_ICMSPresumido = :Aliquota_ICMSPresumido'
      'WHERE'
    ...
    SQLRefresh.Strings = (
        ...
        ' Valor_BCICMSPresumido, Valor_ICMSPresumido, Aliquota_ICMSPresum' +
        'ido FROM NotasItens'
      'WHERE'
  ...
  object NotasTerceirosItens: TMSQuery
    SQLInsert.Strings = (
      'INSERT INTO NotasTerceirosItens'
        ...
        'sa, Navio, Valor_IR, Valor_CSLL, Valor_INSS)'
      'VALUES'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'Valor_IR, Valor_CSLL = :Valor_CSLL, Valor_INSS = :Valor_INSS'
      'WHERE'
    ...
    SQLRefresh.Strings = (
        ...
        'espesa, Navio, Valor_IR, Valor_CSLL, Valor_INSS FROM NotasTercei' +
        'rosItens'
      'WHERE'
  ...
  object CIAP: TMSQuery
    ...
    SQLRefresh.Strings = (
        ...
        'SELECT CIAP.Registro, CIAP.Codigo_Mercadoria, CIAP.Nota, CIAP.Da' +
        'ta_Nota, CIAP.Fornecedor, CIAP.Parcela, CIAP.Utilizacao, CIAP.Da' +
        'ta_Aquisicao, CIAP.Origem FROM CIAP'
      'WHERE CIAP.Registro = :Registro ')
    Connection = Dados.Banco_Empresas
    SQL.Strings = (
      'SELECT * FROM CIAP')
    FetchRows = 1
  ...
  object NCM: TMSQuery
    SQLInsert.Strings = (
      ...
      'VALUES'
        ...
        '_Reducao2, :PIS_ST, :Tratamento_TribICMS)')
    SQLDelete.Strings = (
      'DELETE FROM NCM'
      'WHERE'
      '  NCM = :Old_NCM')
  ...
  object Imobilizado: TMSQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
        ...
        '  Codigo_Sistema = :Old_Codigo_Sistema AND Fornecedor = :Old_For' +
        'necedor AND Nota = :Old_Nota')
    SQLUpdate.Strings = (
      'UPDATE Imobilizado'
      'SET'
    ...
    SQLRefresh.Strings = (
        ...
        'SELECT Imobilizado.Codigo_Sistema, Imobilizado.Codigo, Imobiliza' +
        'do.Codigo_Principal, Imobilizado.Descricao, Imobilizado.Tipo_Mov' +
        'imentacao, Imobilizado.Fornecedor, Imobilizado.Data_Nota, Imobil' +
        'izado.Nota, Imobilizado.Serie, Imobilizado.Modelo, Imobilizado.I' +
        'CMS_Proprio, Imobilizado.ICMS_ST, Imobilizado.ICMS_Frete, Imobil' +
        'izado.ICMS_Dif_Aliquota, Imobilizado.Valor_Credito, Imobilizado.' +
        'Ordem_Item, Imobilizado.Saida_Motivo, Imobilizado.Saida_Nota, Im' +
        'obilizado.Saida_DataNota, Imobilizado.Saida_Modelo, Imobilizado.' +
        'Saida_Serie, Imobilizado.Saida_Item, Imobilizado.Saida_Meses, Im' +
        'obilizado.Saida_AliquotaICMS, Imobilizado.Funcao, Imobilizado.Ti' +
        'po_CalculoCredito, Imobilizado.Valor_Aquisicao, Imobilizado.Valo' +
        'r_Depreciacao, Imobilizado.Apropriacao_Inicial, Imobilizado.Apro' +
        'priacao_Meses, Imobilizado.Parcelas, Imobilizado.Apropriadas, Im' +
        'obilizado.Fim_Apropriacao, Imobilizado.Tipo_Item, Imobilizado.Ce' +
        'ntro_Custo, Imobilizado.Vida_Util, Imobilizado.Tipo_Movimentacao' +
        'Saida, Imobilizado.Conta_Numero, Imobilizado.Conta_Nome, Imobili' +
        'zado.Conta_Natureza, Imobilizado.Conta_Tipo, Imobilizado.Conta_N' +
        'ivel, Imobilizado.AnoMes_Faturamento FROM Imobilizado'
      
        'WHERE Imobilizado.Codigo_Sistema = :Codigo_Sistema AND Imobiliza' +
        'do.Fornecedor = :Fornecedor AND Imobilizado.Nota = :Nota ')
    Connection = Dados.Banco_Empresas
    SQL.Strings = (
  ...
  object ProdutosTransferencia: TMSQuery
    ...
    object ProdutosTransferenciaMotivo: TStringField
      FieldName = 'Motivo'
      Origin = 'ProdutosTransferencia.Motivo'
      FixedChar = True
      Size = 1
    end
  ...
  object NotasTerceiros: TMSQuery
    ...
    SQLRefresh.Strings = (
        ...
        'R, Valor_CSLL, Valor_INSS, Armazem FROM NotasTerceiros'
      'WHERE'
  ...
  object NotasItensNavios: TMSQuery
    ...
    object NotasItensNaviosCodigo_Mercadoria: TSmallintField
      FieldName = 'Codigo_Mercadoria'
    end
  ...
  object CreditoPresumido: TMSQuery
    ...
    object CreditoPresumidoBeneficio: TSmallintField
      FieldName = 'Beneficio'
    end
