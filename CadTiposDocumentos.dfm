object fCadTiposDocumentos: TfCadTiposDocumentos
  Left = 0
  Top = 0
  Width = 991
  Height = 1001
  ...
  object dsTiposDoc: TDataSource
    DataSet = TipoDocumento
    Left = 37
    Top = 199
  end
  object TipoDocumento: TFDQuery
    BeforePost = TipoDocumentoBeforePost
    BeforeDelete = TipoDocumentoBeforeDelete
