...
type
  TfCadLocaisDesembaraco = class(TUniFrame)
    ...
    cCodigo: TUniDBEdit;
    cPrazo_Registro: TUniDBEdit;
    cPrazo_Faturamento: TUniDBEdit;
...
procedure TfCadLocaisDesembaraco.bAdicionarClick(Sender: TObject);
begin
      with Locais do begin
           try
               LigaBotoes(false);
               Append;
           except
...
procedure TfCadLocaisDesembaraco.bExcluirClick(Sender: TObject);
begin
     with Locais do begin
...
procedure TfCadLocaisDesembaraco.bGravarClick(Sender: TObject);
begin
      with Locais do begin
          {
           ...
           if (State = dsInsert) and (Existe(Locais, 'Codigo', FieldByName('Codigo').AsString)) then begin
...
procedure TfCadLocaisDesembaraco.bCancelarClick(Sender: TObject);
begin
      Locais.Cancel;
      LigaBotoes(true);
end;

procedure TfCadLocaisDesembaraco.bEditarClick(Sender: TObject);
begin
     try
         LigaBotoes(false);
         Locais.Edit;
...
procedure TfCadLocaisDesembaraco.UniFrameDestroy(Sender: TObject);
var
   i:integer;
begin
...
procedure TfCadLocaisDesembaraco.bFecharClick(Sender: TObject);
begin
      MainForm.PagePrincipal.Pages[MainForm.PagePrincipal.ActivePageIndex].free;
end;

procedure TfCadLocaisDesembaraco.LigaBotoes(Estado:boolean);
begin
...
procedure TfCadLocaisDesembaraco.UniFrameCreate(Sender: TObject);
var
  i:integer;
begin
      ...
      Locais.sql.clear;
      Locais.sql.add('select *');
      Locais.sql.add('from LocalDesembaraco');
      Locais.sql.add('order by Codigo');
      Locais.open;
end;
procedure TfCadLocaisDesembaraco.cPesquisaKeyDown(Sender: TObject; var Key: Word;Shift: TShiftState);
begin
...
procedure TfCadLocaisDesembaraco.bPesquisaClick(Sender: TObject);
begin
     Locais.Cancel;
     LigaBotoes(true);
...
procedure TfCadLocaisDesembaraco.RecursosBeforeDelete(DataSet: TDataSet);
begin
