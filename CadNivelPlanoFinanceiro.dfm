object fCadNivelClassificacao: TfCadNivelClassificacao
  Left = 0
  Top = 0
  Width = 991
  Height = 1001
  ...
  object dsNivelClass: TDataSource
    DataSet = NivelClass
    Left = 34
    Top = 133
  end
  object NivelClass: TFDQuery
    BeforePost = NivelClassBeforePost
    BeforeDelete = NivelClassBeforeDelete
    Connection = UniMainModule.Conecta
    UpdateOptions.AssignedValues = [uvEUpdate, uvAutoCommitUpdates]
    UpdateOptions.AutoCommitUpdates = True
    SQL.Strings = (
      'SELECT * FROM NivelClassificacao')
    Left = 36
    Top = 77
  end
