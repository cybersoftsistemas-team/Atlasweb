...
type
  TfCtbLancamentos = class(TUniFrame)
    ...
    tTotalizaCredAno: TBCDField;
    tTotalizaCredDia: TBCDField;
    tTotalizaCredLote: TBCDField;
    tTotalizaCredMes: TBCDField;
    tTotalizaDebAno: TBCDField;
    tTotalizaDebDia: TBCDField;
    tTotalizaDebLote: TBCDField;
    tTotalizaDebMes: TBCDField;
    tTotalizaDifAno: TBCDField;
    tTotalizaDifDia: TBCDField;
    tTotalizaDifLote: TBCDField;
    tTotalizaDifMes: TBCDField;
