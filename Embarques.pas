...
type
  TfEmbarques = class(TUniFrame)
    ...
    tSomaM3: TBCDField;
    tSomaLITROS: TBCDField;
    tBLRegistro: TIntegerField;
    tBLNavio1: TIntegerField;
    tBLNavio: TIntegerField;
    tBLBL: TStringField;
    tBLData_Emissao: TSQLTimeStampField;
    tBLTon_Vac: TBCDField;
    tBLTon_Air: TBCDField;
    tBLQuantidade_M315: TBCDField;
    tBLQuantidade_M320: TBCDField;
    tBLQuantidade_LT20: TBCDField;
    tBLEndossado: TBooleanField;
    tBLBloqueado: TBooleanField;
    tBLObservacao: TMemoField;
    tBLLaudo: TStringField;
    tBLQuantidade_LT15: TBCDField;
    tBLPorto: TStringField;
    tBLArmazem: TSmallintField;
    tBLQuantidade_EmbM315: TBCDField;
    tBLQuantidade_EmbLT15: TBCDField;
    tBLQuantidade_EmbM320: TBCDField;
    tBLQuantidade_EmbLT20: TBCDField;
    ...
    tLaudosQuantidade_M320: TBCDField;
    tLaudosQuantidade_LT20: TBCDField;
    tLaudosQuantidade_RecebidaM320: TBCDField;
    tLaudosQuantidade_RecebidaLT20: TBCDField;
    tLaudosVariacao_DesLT: TBCDField;
    tLaudosVariacao_DesPerc: TBCDField;
    tLaudosObservacao: TMemoField;
    tLaudosVariacao_EmbLT: TBCDField;
    tLaudosVariacao_EmbPerc: TBCDField;
    ...
    tNotasTotal: TBCDField;
    tNotasQuantidade: TBCDField;
    ...
    tEmbarquesPremium: TBCDField;
    tEmbarquesTranshipment: TBCDField;
    tEmbarquesFator_Conversao: TBCDField;
    tEmbarquesDescarga_Trigger: TBCDField;
    ...
    tEmbarquesQuantidade_15: TBCDField;
    tEmbarquesQuantidade_20: TBCDField;
    tEmbarquesTipo_Descarga: TStringField;
    tEmbarquesValor_Demurrage: TBCDField;
    tEmbarquesTempo_Demurrage: TBCDField;
    tEmbarquesTotal_ME: TBCDField;
    tEmbarquesCusto_Navio: TBCDField;
    tEmbarquesObservacao: TMemoField;
    tEmbarquesStatus: TStringField;
    tEmbarquesData_Partida: TSQLTimeStampField;
    tEmbarquesQuantidade_Carga: TBCDField;
