object fContab_BloquearPeriodo: TfContab_BloquearPeriodo
  Left = 0
  Top = 0
  Width = 1066
  Height = 723
  ...
  object FechamentoContabil: TFDQuery
    AfterScroll = FechamentoContabilAfterScroll
    OnCalcFields = FechamentoContabilCalcFields
    ...
    object FechamentoContabilEmpresa: TStringField
      FieldName = 'Empresa'
      Origin = 'Empresa'
      Size = 14
    end
    object FechamentoContabilCadeado: TStringField
