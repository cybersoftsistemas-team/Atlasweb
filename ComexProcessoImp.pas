...
type
  TfComexProcessoImp = class(TUniFrame)
    ...
    ProcessosImpValor_FOB: TBCDField;
    ProcessosImpValor_Frete: TBCDField;
    ProcessosImpValor_Seguro: TBCDField;
    ProcessosImpValor_II: TBCDField;
    ProcessosImpICMS_DIferido: TBooleanField;
    ProcessosImpAliquota_ICMS: TBCDField;
    ProcessosImpValor_ICMS: TBCDField;
    ProcessosImpUF_Desembaraco: TStringField;
    ProcessosImpQuantidade: TBCDField;
    ProcessosImpVolumes: TBCDField;
    ProcessosImpEspecie: TStringField;
    ProcessosImpQuantidade_Liberada: TBCDField;
    ProcessosImpQuantidade_Digitada: TBCDField;
    ProcessosImpPeso_Bruto: TBCDField;
    ProcessosImpPeso_Liquido: TBCDField;
    ProcessosImpNumero_Fatura: TStringField;
    ProcessosImpData_Fatura: TDateField;
    ProcessosImpValor_FOBME: TBCDField;
    ProcessosImpMoeda_FOB: TSmallintField;
    ProcessosImpTaxa_FOB: TBCDField;
    ProcessosImpValor_FreteME: TBCDField;
    ProcessosImpMoeda_Frete: TSmallintField;
    ProcessosImpTaxa_Frete: TBCDField;
    ProcessosImpValor_SeguroME: TBCDField;
    ProcessosImpMoeda_Seguro: TSmallintField;
    ProcessosImpTaxa_Seguro: TBCDField;
    ...
    ProcessosImpValor_PIS: TBCDField;
    ProcessosImpValor_COFINS: TBCDField;
    ProcessosImpValor_IPI: TBCDField;
    ProcessosImpVencimento_Cambio: TSmallintField;
    ProcessosImpCourrier: TBooleanField;
    ProcessosImpDocumento_Carga: TStringField;
    ProcessosImpValor_AdValorem: TBCDField;
    ...
    ProcessosImpMargem_Lucro: TBCDField;
    ProcessosImpDesconto_Operacional: TBCDField;
    ProcessosImpDesconto_Adicional: TBCDField;
    ProcessosImpData_Encerramento: TDateField;
    ProcessosImpData_BL: TDateField;
    ProcessosImpValor_FaturaME: TBCDField;
    ...
    ProcessosImpValor_FatorFaturamento: TBCDField;
    ProcessosImpValor_FatorSISCOMEX: TBCDField;
    ProcessosImpValor_MargemLucro: TBCDField;
    ProcessosImpValor_DescontoAdicional: TBCDField;
    ProcessosImpValor_DescontoOperacional: TBCDField;
    ProcessosImpValor_Dumping: TBCDField;
    ProcessosImpCondicao_Cambio: TSmallintField;
    ProcessosImpPais_Origem: TStringField;
    ProcessosImpValor_TaxaSISCOMEX: TBCDField;
    ProcessosImpReducao_ICMS: TBCDField;
    ProcessosImpObservacao: TMemoField;
    ProcessosImpValor_FOBMEAdicoes: TBCDField;
    ProcessosImpValor_FOBAdicoes: TBCDField;
    ProcessosImpDA: TBooleanField;
    ProcessosImpReducao_BC: TBCDField;
    ProcessosImpValor_PIS2: TBCDField;
    ProcessosImpValor_COFINS2: TBCDField;
    ...
    ProcessosImpReducao_PIS: TBCDField;
    ProcessosImpReducao_COFINS: TBCDField;
    ProcessosImpPIS_NFEntrada: TBCDField;
    ProcessosImpPIS_NFESaida: TBCDField;
    ProcessosImpCOFINS_NFEntrada: TBCDField;
    ProcessosImpCOFINS_NFESaida: TBCDField;
    ProcessosImpPIS_Majorada: TBCDField;
    ProcessosImpCOFINS_Majorada: TBCDField;
    ...
    ProcessosImpValor_FatorFrete: TBCDField;
    ProcessosImpPrevisao_FreteTransportador: TSmallintField;
    ProcessosImpValor_FatorSISCOMEXReal: TBCDField;
    ProcessosImpValor_FatorFreteReal: TBCDField;
    ProcessosImpValor_FatorFaturamentoReal: TBCDField;
    ProcessosImpData_PrevArmazem: TDateField;
    ProcessosImpValor_FatorArmazem: TBCDField;
    ProcessosImpValor_FatorArmazemReal: TBCDField;
    ...
    ProcessosImpValor_AFRMM: TBCDField;
    ...
    ProcessosImpValor_FreteNacionalME: TBCDField;
    ProcessosImpValor_FreteNacionalReal: TBCDField;
    ProcessosImpRecinto_Aduaneiro: TIntegerField;
    ProcessosImpAd_Valorem: TBCDField;
    ProcessosImpArmazem: TSmallintField;
    ProcessosImpCIDE_ValorDevido: TBCDField;
    ProcessosImpCIDE_ValorRecolher: TBCDField;
