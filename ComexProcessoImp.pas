...
type
  TfComexProcessoImp = class(TUniFrame)
    ...
    ProcessosImpEntreposto: TBooleanField;
    ProcessosImpDUIMP: TStringField;
    ProcessosImpData_Registro: TDateField;
    ProcessosImpData_Desembaraco: TDateField;
    ProcessosImpValor_FOB: TCurrencyField;
    ProcessosImpValor_Frete: TCurrencyField;
    ProcessosImpValor_Seguro: TCurrencyField;
    ProcessosImpValor_II: TCurrencyField;
    ProcessosImpICMS_DIferido: TBooleanField;
    ProcessosImpAliquota_ICMS: TFloatField;
    ProcessosImpValor_ICMS: TCurrencyField;
    ProcessosImpUF_Desembaraco: TStringField;
    ProcessosImpQuantidade: TFloatField;
    ProcessosImpVolumes: TFloatField;
    ProcessosImpEspecie: TStringField;
    ProcessosImpQuantidade_Liberada: TFloatField;
    ProcessosImpQuantidade_Digitada: TFloatField;
    ProcessosImpPeso_Bruto: TFloatField;
    ProcessosImpPeso_Liquido: TFloatField;
    ProcessosImpNumero_Fatura: TStringField;
    ProcessosImpData_Fatura: TDateField;
    ProcessosImpValor_FOBME: TCurrencyField;
    ProcessosImpMoeda_FOB: TSmallintField;
    ProcessosImpTaxa_FOB: TFloatField;
    ProcessosImpValor_FreteME: TCurrencyField;
    ProcessosImpMoeda_Frete: TSmallintField;
    ProcessosImpTaxa_Frete: TFloatField;
    ProcessosImpValor_SeguroME: TCurrencyField;
    ProcessosImpMoeda_Seguro: TSmallintField;
    ProcessosImpTaxa_Seguro: TFloatField;
    ProcessosImpCondicao_Pgto: TStringField;
    ProcessosImpTipo_Mercadoria: TIntegerField;
    ProcessosImpNome_Transporte: TStringField;
    ProcessosImpLocal_Embarque: TStringField;
    ProcessosImpLocal_Desembarque: TStringField;
    ProcessosImpConhecimento_Embarque: TStringField;
    ProcessosImpData_DOC: TDateField;
    ProcessosImpAgencia_Maritima: TStringField;
    ProcessosImpNavio_DataPrevista: TDateField;
    ProcessosImpNavio_DataChegada: TDateField;
    ProcessosImpCliente: TIntegerField;
    ProcessosImpProcesso_Abertura: TDateField;
    ProcessosImpProcesso_Fechamento: TDateField;
    ProcessosImpConta_Impostos: TStringField;
    ProcessosImpConta_Despesas: TStringField;
    ProcessosImpBloqueado: TBooleanField;
    ProcessosImpExportador: TSmallintField;
    ProcessosImpRE_Numero: TStringField;
    ProcessosImpRE_DataAverbacao: TDateField;
    ProcessosImpDespachante: TSmallintField;
    ProcessosImpCanal_SISCOMEX: TStringField;
    ProcessosImpValor_PIS: TCurrencyField;
    ProcessosImpValor_COFINS: TCurrencyField;
    ProcessosImpValor_IPI: TCurrencyField;
    ProcessosImpVencimento_Cambio: TSmallintField;
    ProcessosImpCourrier: TBooleanField;
    ProcessosImpDocumento_Carga: TStringField;
    ProcessosImpValor_AdValorem: TCurrencyField;
    ProcessosImpBeneficio_Fiscal: TStringField;
    ProcessosImpTipo_Declaracao: TSmallintField;
    ProcessosImpNatureza_Exportacao: TSmallintField;
    ProcessosImpTipo_Conhecimento: TSmallintField;
    ProcessosImpConta_Adiantamento: TStringField;
    ProcessosImpModalidade: TSmallintField;
    ProcessosImpResponsavel: TStringField;
    ProcessosImpContainer_Numero: TStringField;
    ProcessosImpProcesso_Mestre: TStringField;
    ProcessosImpCNPJ_Importado: TStringField;
    ProcessosImpMargem_Lucro: TFloatField;
    ProcessosImpDesconto_Operacional: TFloatField;
    ProcessosImpDesconto_Adicional: TFloatField;
    ProcessosImpData_Encerramento: TDateField;
    ProcessosImpData_BL: TDateField;
    ProcessosImpValor_FaturaME: TCurrencyField;
    ProcessosImpData_PrevFaturamento: TDateField;
    ProcessosImpData_PrevRegistro: TDateField;
    ProcessosImpLocal_Desembaraco: TIntegerField;
    ProcessosImpDesativado: TBooleanField;
    ProcessosImpValor_FatorFaturamento: TFloatField;
    ProcessosImpValor_FatorSISCOMEX: TFloatField;
    ProcessosImpValor_MargemLucro: TCurrencyField;
    ProcessosImpValor_DescontoAdicional: TCurrencyField;
    ProcessosImpValor_DescontoOperacional: TCurrencyField;
    ProcessosImpValor_Dumping: TCurrencyField;
    ProcessosImpCondicao_Cambio: TSmallintField;
    ProcessosImpPais_Origem: TStringField;
    ProcessosImpValor_TaxaSISCOMEX: TCurrencyField;
    ProcessosImpReducao_ICMS: TFloatField;
    ProcessosImpObservacao: TMemoField;
    ProcessosImpValor_FOBMEAdicoes: TCurrencyField;
    ProcessosImpValor_FOBAdicoes: TCurrencyField;
    ProcessosImpDA: TBooleanField;
    ProcessosImpReducao_BC: TFloatField;
    ProcessosImpValor_PIS2: TCurrencyField;
    ProcessosImpValor_COFINS2: TCurrencyField;
    ProcessosImpMemorando_Exportacao: TIntegerField;
    ProcessosImpCT_Numero: TStringField;
    ProcessosImpCT_Data: TDateField;
    ProcessosImpCT_Modelo: TStringField;
    ProcessosImpCT_Serie: TStringField;
    ProcessosImpOrigem_Mercadoria: TSmallintField;
    ProcessosImpBanco: TSmallintField;
    ProcessosImpReducao_PIS: TFloatField;
    ProcessosImpReducao_COFINS: TFloatField;
    ProcessosImpPIS_NFEntrada: TFloatField;
    ProcessosImpPIS_NFESaida: TFloatField;
    ProcessosImpCOFINS_NFEntrada: TFloatField;
    ProcessosImpCOFINS_NFESaida: TFloatField;
    ProcessosImpPIS_Majorada: TFloatField;
    ProcessosImpCOFINS_Majorada: TFloatField;
    ProcessosImpSuspensao_Impostos: TBooleanField;
    ProcessosImpRemover_Valoracao: TBooleanField;
    ProcessosImpReferencia_Cliente: TStringField;
    ProcessosImpAdmissao_Temporaria: TBooleanField;
    ProcessosImpCondicao_Pagamento: TSmallintField;
    ProcessosImpData_PrevFrete: TDateField;
    ProcessosImpValor_FatorFrete: TCurrencyField;
    ProcessosImpPrevisao_FreteTransportador: TSmallintField;
    ProcessosImpValor_FatorSISCOMEXReal: TCurrencyField;
    ProcessosImpValor_FatorFreteReal: TCurrencyField;
    ProcessosImpValor_FatorFaturamentoReal: TCurrencyField;
    ProcessosImpData_PrevArmazem: TDateField;
    ProcessosImpValor_FatorArmazem: TCurrencyField;
    ProcessosImpValor_FatorArmazemReal: TCurrencyField;
    ProcessosImpPrevisao_ArmazemFornecedor: TSmallintField;
    ProcessosImpReferencia_DataEntrega: TDateField;
    ProcessosImpCST_PIS: TStringField;
    ProcessosImpCST_COFINS: TStringField;
    ProcessosImpCodigo_BCCredito: TStringField;
    ProcessosImpApuracao_PISCOFINS: TBooleanField;
    ProcessosImpConsignatario_UF: TStringField;
    ProcessosImpConsignatario_CNPJ: TStringField;
    ProcessosImpValor_AFRMM: TCurrencyField;
    ProcessosImpPreco_Venda: TBooleanField;
    ProcessosImpProforma_Numero: TStringField;
    ProcessosImpProforma_Data: TDateField;
    ProcessosImpCondicao_Frete: TStringField;
    ProcessosImpSeguradora: TStringField;
    ProcessosImpProforma_DataTaxa: TDateField;
    ProcessosImpData_TaxaFatura: TDateField;
    ProcessosImpData: TDateField;
    ProcessosImpROF_Numero: TStringField;
    ProcessosImpROF_Emissao: TDateField;
    ProcessosImpROF_Dias: TSmallintField;
    ProcessosImpNotificar: TSmallintField;
    ProcessosImpURF_Despacho: TStringField;
    ProcessosImpReferencia_Despachante: TStringField;
    ProcessosImpVia_Transporte: TSmallintField;
    ProcessosImpRateia_FretePeso: TBooleanField;
    ProcessosImpRemover_FreteNacBC: TBooleanField;
    ProcessosImpValor_FreteNacionalME: TCurrencyField;
    ProcessosImpValor_FreteNacionalReal: TCurrencyField;
    ProcessosImpRecinto_Aduaneiro: TIntegerField;
    ProcessosImpAd_Valorem: TCurrencyField;
    ProcessosImpArmazem: TSmallintField;
    ProcessosImpCIDE_ValorDevido: TCurrencyField;
    ProcessosImpCIDE_ValorRecolher: TCurrencyField;
    ProcessosImpEnquadramento_Operacao: TStringField;
    ProcessosImpEstoque_Bloqueado: TBooleanField;
    ProcessosImpExonerado: TBooleanField;
    ProcessosImpIndicador_InfCompl: TStringField;
    ProcessosImpIndicador_RecintoAlf: TSmallintField;
    ProcessosImpLocal_EmbarqueCod: TIntegerField;
    ProcessosImpNavio_Ordem: TIntegerField;
    ProcessosImpNavio_PrevSaida: TSQLTimeStampField;
...
begin
      ...
      for i := 0 to ComponentCount -1 do begin
          if (Components[i] is TUniPanel) and (pos('Interno', Components[i].Name) = 0) then begin
