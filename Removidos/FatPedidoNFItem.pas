...
uses
  ...
  FireDAC.Comp.Client, uniPageControl, uniMemo, uniBasicGrid, uniStringGrid, CalcExpress, System.RegularExpressions, uniGroupBox, uniHTMLFrame;
...
type
  TfFatPedidoNFItem = class(TUniForm)
    ...
    cValor_MediaBCR: TUniDBFormattedNumberEdit;
...
procedure TfFatPedidoNFItem.bAddTudoClick(Sender: TObject);
begin
     close;
end;
